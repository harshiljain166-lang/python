...
# print(comp)
# you=int(input("press 1 for rock, press 2 for paper , press 3 for scissors  : "))
...
#     print("you won")
#     human_sore+=1
#     print(f"you won this round \n current score -you-{human_sore} and - {computer_score}")
#  elif you==2 and comp==1:
#     print("you won")
#     human_sore+=1
#     print(f"you won this round \n current score -you-{human_sore} and - {computer_score}")
...
#  else:
#     print("you loss")
#     print(f"you loss {human_sore} and computer-{computer_score}")
